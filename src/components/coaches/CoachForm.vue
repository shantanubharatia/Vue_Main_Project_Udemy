<template>
    <form @submit.prevent = "submitForm">
        ...
        <div class="form-control" :class="{invalid: !description.isValid}">
            ...
            <textarea rows="5" type="text" id="description" v-model.trim="description.val" @blur="clearValidity('description')"></textarea>
        ...
        <div class="form-control" :class="{invalid: !areas.isValid}">
            ...
            <p v-if="!areas.isValid">Atleast one areas of expertise must be selected.</p>
        </div>
